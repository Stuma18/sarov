...
st.set_page_config(page_title = "Код эпсилон-жадного алгоритма")

st.sidebar.success("Код эпсилон-жадного алгоритма")

st.write("# Код эпсилон-жадного алгоритма")
...
mytable_2.field_names = ["Номер такта", "Номер банера", 
    "Количество пользователей", "Количество конверсий", 
    "Оценка вероятности конверсии"]
...
while i < N_takt:
    ...
    if rand > eps:
        ...
        estimate_0, n_0, use_0 = p(banners[max_ind]['n_conv'], 
            conversion[max_ind], banners[max_ind]['n_users'])
        ...
        estimate_0, n_0, use_0 = p(banners[mid_ind]['n_conv'], 
            conversion[mid_ind], banners[mid_ind]['n_users'])
        ...
        estimate_0, n_0, use_0 = p(banners[min_ind]['n_conv'], 
            conversion[min_ind], banners[min_ind]['n_users'])
