...
int main()
{
	...
	cudaEventRecord(event1, 0);
		cudaMemcpyAsync(d_A, h_A, N * sizeof(double), cudaMemcpyHostToDevice); CHECK_ERR("memcpy_1\n");
		cudaMemcpyAsync(d_B, h_B, N * sizeof(double), cudaMemcpyHostToDevice); CHECK_ERR("memcpy_2\n");
