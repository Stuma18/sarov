...
to go
  ifelse trace?[ ask birds [pendown]]
  [ask birds [penup] cd]
  ask birds [
    update-heading
...
to update-heading
  ...
  ;let mates other birds in-cone vision 90
  let dx-new dx
  let dy-new dy
  if any? mates
  [
...
to-report dist
  report mean [min [distance myself] of other birds] of birds
end

to-report speed
  report mean [mean [dx * [dx] of myself + dy * [dy] of myself] of other birds] of birds
end

to-report neighbour
  report mean [count birds in-radius vision ] of birds
end
...
"" ""
PENS
"distance" 1.0 0 -16777216 true "" "plot dist"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot neighbour"
